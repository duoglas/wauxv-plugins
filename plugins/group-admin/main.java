...
void onLoad() {
    List enabled = getEnabledGroups();
    log("GroupAdmin v1.15.0 loading, owner=" + getLoginWxid() + ", enabled groups=" + enabled.size());
    ...
    delay(5000, new Runnable() {
        public void run() {
            ...
            log("GroupAdmin v1.15.0 baseline check: 已启用群 " + groups.size() + ", 新建基线群 " + touched + ", 新增 first_seen " + totalAdded + " 人");
            // _probeGroupInfoAPI();
        }
    });
